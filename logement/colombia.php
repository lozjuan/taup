        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <article class="col-12 col-md-10" id="images-project">
                    <div class="images">
                        <h4 id="project-title"><?php echo $TEXTS['colombia']['title'] ?></h4>
                        <img style="width: 50%; height: auto;"  src="../images/col_1.jpg" alt="">
                        <p id="after-image">
                            <?php echo $TEXTS['colombia'][0] ?>
                        </p>
                        <img src="../images/col_2.jpg" alt="">
                        <img src="../images/col_3.jpg" alt="">
                        <img src="../images/col_4.jpg" alt="">
                    </div>
                </article>
            </div>
        </div>
