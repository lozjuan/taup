        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <article class="col-12 col-md-10" id="images-project">
                    <div class="images">
                        <h4 id="project-title"><?php echo $TEXTS['japon']['title'] ?></h4>
                        <img src="../images/jap_1.jpg" alt="">
                        <p id="after-image">
                            <?php echo $TEXTS['japon'][0] ?>
                        </p>
                        <img src="../images/jap_2.jpg" alt="">
                        <p id="after-image">
                            <?php echo $TEXTS['japon'][1] ?>
                        </p>
                        <img src="../images/jap_3.jpg" alt="">
                        <img src="../images/jap_4.jpg" alt="">
                        <p id="after-image">
                            <?php echo $TEXTS['japon'][1] ?>
                        </p>
                    </div>
